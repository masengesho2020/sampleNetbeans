...
public class AddDiagnosisInformation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ADD DIAGNOSIS INFORMATIONS");
        ...
        jLabel3.setText("This PatientID Does not Exist!");
        ...
        jLabel7.setText("Word required?");

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel8.setText("Type Word");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Single", "Married", "General", "Duo" }));
...
//            e.printStackTrace();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(Message==1){
            ...
            if(jCheckBox1.isSelected()){
                wordRequired="YES";
                typeword=(String)jComboBox1.getSelectedItem();
            }
            else{
                wordRequired="NO";
                typeword="";
            ...
            try {
                Connection con=ConnectionProvider.getcon();
                Statement st=con.createStatement();
                          st.executeUpdate("INSERT INTO prescription VALUES('"+patientID+"','"+symptoms+"','"+diagnosis+"','"+medicine+"','"+wordRequired+"','"+typeword+"')");
